...
int runprog()
{
    ...
    do {
        // MARK: NOTE: Understand where this is going...
        // Application->ProcessMessages();
        if(inputMode)
            // FIXME: Is this really necessary for Mac OS X?
    ...
    if (trace || halt) {
        ...
        // MARK: I/O: Disable full-screen and set up window
